void slopeSlopeCMCorrelation(const char* file1, const char* file2)
{
  ...
  TH2F* slopeCorr = new TH2F("slopeCorr", "Correlation of the common mode slope;Slope1 [ADC / Ch.];Slope2 [ADC / Ch.]", 200, -1, 1, 200, -1, 1);
  ...
  for(int i = 0; i < nEntries; ++i)
    {
      ...
      slopeCorr->Fill(commM1[1], commM2[1]);
    }
